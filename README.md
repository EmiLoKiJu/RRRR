...
# 📖 [RRRR] <a name="about-project"></a>
RRRR, is a way to greet someone in a very difficult way
...
<!-- https://github.com/EmiLoKiJu/RRRR -->
...
```
cd my-folder
git clone https://github.com/EmiLoKiJu/RRRR.git
```
...
Go to http://127.0.0.1:5000/ and see it working.
...
Then check the link of the rails server (it should have changed to http://127.0.0.1:3000/)

### Run tests

Not implemented tests

<p align="right">(<a href="#RRRR">back to top</a>)</p>
